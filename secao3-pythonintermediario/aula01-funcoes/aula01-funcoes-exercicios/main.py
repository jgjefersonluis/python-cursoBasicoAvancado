...
"""
4 - Fizz Buzz - Se o parâmetro da função for divisivel por 3, retorne fizz, se o parâmetro da função for divisível por , retorne buzz. Se o parâmetro da função for divisível por 5 e por 3, retorne FizzBuzz, caso cotrario, retorne o número enviado.
"""
